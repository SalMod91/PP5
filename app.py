...
from app_pages.page_1_summary import (
    page_1_summary_body
)
from app_pages.page_2_sale_price_study import (
    page_2_sale_price_study_body
)
from app_pages.page_3_sale_price_prediction import (
    page_3_sale_price_prediction_body
)
from app_pages.page_4_hypothesis_and_validation import (
    page_4_hypothesis_validation_body
)
from app_pages.page_5_ml_model import (
    page_5_ml_model_body
)
